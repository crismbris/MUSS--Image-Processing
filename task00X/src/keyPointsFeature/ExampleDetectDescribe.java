...
//		DetectDescribePoint detDesc = createFromComponents(imageType);
		...
		BufferedImage imageA = UtilImageIO.loadImage(UtilIO.pathExample("C:\\Users\\Cristina\\eclipse-workspace\\Images\\key/cafe1.PNG"));
		BufferedImage imageB = UtilImageIO.loadImage(UtilIO.pathExample("C:\\Users\\Cristina\\eclipse-workspace\\Images\\key/cafe2.jpg"));
