...
public class exercise_04b_closing {
	...
	public static void main(String []args) {
		if(args.length!=2) {
			System.out.println("ERROR: format input exercice_04a_closing <file> <dimension> ");
    		System.exit(1);
    	}
		...
		GrayU8 aux = auxiliary0X.closing(im8, dim, values);
		
		UtilImageIO.saveImage(aux, "tema2_im/04b/closingD"+dim+".pgm");
        System.out.println("Archivo: closingD"+dim+".pgm");
