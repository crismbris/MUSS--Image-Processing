...
public class exercise_05b_idemClosing {
	...
	public static void main (String [] args) {
		if(args.length!=2) {
			System.out.println("ERROR: format input exercice_07a_idemClosing <file> <dimension> ");
    		System.exit(1);
    	}
		...
		im8 = auxiliary0X.closing(im8, dim, values);
		aux= auxiliary0X.closing(im8, dim, values);
