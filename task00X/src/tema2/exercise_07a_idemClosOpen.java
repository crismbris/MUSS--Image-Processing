...
public class exercise_07a_idemClosOpen {
	...
	public static void main (String [] args) {
		if(args.length!=2) {
			System.out.println("ERROR: format input exercice_07a_idemClosOp <file> <dimension> ");
    		System.exit(1);
    	}
		...
		aux = auxiliary0X.closing_opening(im8, dim, values);
