...
public class exercise_06a_closing_opening {
	...
	public static void main (String [] args) {
		if(args.length!=2) {
			System.out.println("ERROR: format input exercice_06a_closing_opening <file> <dimension> ");
    		System.exit(1);
    	}
		...
		im8 = auxiliary0X.closing_opening(im8, dim, values);
		
		UtilImageIO.saveImage(im8, "tema2_im/06a/closing_openingD"+dim+".pgm");
        System.out.println("Archivo: closing_openingD"+dim+".pgm");
