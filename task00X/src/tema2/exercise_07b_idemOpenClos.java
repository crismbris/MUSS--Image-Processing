...
public class exercise_07b_idemOpenClos {
	...
	public static void main (String [] args) {
		if(args.length!=2) {
			System.out.println("ERROR: format input exercice_07b_idemOpenClos <file> <dimension> ");
    		System.exit(1);
    	}
		...
		aux = auxiliary0X.opening_closing(im8, dim, values);
